...
<div class="p-4 md:p-8 max-w-4xl mx-auto animate__animated animate__fadeIn">
    ...
    <div class="mb-10">
        ...
        <h1 class="text-3xl font-extrabold text-emerald-950 dark:text-white tracking-tight uppercase italic">Tambah Kategori Baru</h1>
        <p class="text-emerald-600 dark:text-emerald-400 font-medium mt-1">Lengkapi data klasifikasi kategori surat untuk sistem AKSARA</p>
    </div>
            ...
            <div class="space-y-8">
                ...
                <div>
                    ...
                    <textarea name="keterangan" 
                              ...
                              class="w-full bg-emerald-50/50 dark:bg-emerald-950/30 border-none rounded-2xl px-6 py-4 text-emerald-900 dark:text-emerald-100 focus:ring-2 focus:ring-emerald-500 font-bold">{{ old('keterangan') }}</textarea>
                </div>
            </div>
