...
@section('title', 'Tambah User Baru - AKSARA')
...
<div class="p-4 md:p-6 space-y-6 animate__animated animate__fadeIn max-w-3xl mx-auto">
    ...
    <div class="bg-white dark:bg-emerald-900/40 p-6 md:p-8 rounded-[2rem] shadow-xl border border-emerald-50 dark:border-emerald-800/50 transition-all duration-300">
        <form action="{{ route('admin.master.user.store') }}" method="POST" class="space-y-6">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="nama_lengkap" value="{{ old('nama_lengkap') }}" required placeholder="Contoh: Ahmad Subagja" 
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="jabatan" value="{{ old('jabatan') }}" required placeholder="Contoh: Staff IT / Kepala Sub Bagian" 
                ...
                <div>
                    ...
                    <input type="text" name="username" value="{{ old('username') }}" required placeholder="Contoh: ahmad_subagja" 
                ...
                {{-- Password --}}
                <div class="md:col-span-2">
                    <label class="block text-[10px] font-black uppercase tracking-widest text-emerald-600 dark:text-emerald-400 mb-2 ml-1">Password</label>
