...
@section('title', 'Tambah Instruksi - AKSARA')
...
<div class="p-4 md:p-8 max-w-4xl mx-auto animate__animated animate__fadeIn">
    ...
    <div class="mb-10">
        ...
        <h1 class="text-3xl font-extrabold text-emerald-950 dark:text-white tracking-tight uppercase italic">Tambah Instruksi Pimpinan</h1>
        <p class="text-emerald-600 dark:text-emerald-400 font-medium mt-1">Buat instruksi baku baru untuk sistem disposisi AKSARA</p>
    </div>
    ...
    <div class="bg-white dark:bg-emerald-900/40 rounded-[2.5rem] p-10 shadow-2xl shadow-emerald-900/5 dark:shadow-black/20 border border-emerald-50 dark:border-emerald-800/50">
        <form action="{{ route('admin.master.instruksi.store') }}" method="POST">
            @csrf
